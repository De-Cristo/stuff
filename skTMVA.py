...
def convert_bdt_sklearn_tmva(sklearn_bdt_clf, input_var_list, tmva_outfile_xml):
    ...
    if(not isinstance(sklearn_bdt_clf, AdaBoostClassifier)) and (not isinstance(sklearn_bdt_clf, GradientBoostingClassifier)):
        print("Unknown type!!!")
    # AdaBoost
    if isinstance(sklearn_bdt_clf, AdaBoostClassifier):
        print("convert_bdt__AdaBoost!!!")
