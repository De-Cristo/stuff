...
if train_SvB_bdt_with_reweightedFailB:
    ...
    bkgpass = np.concatenate((backgroundpass_6_HMP,backgroundpass_7_HMP,backgroundpass_8_HMP))
    bkgfail = np.concatenate((bkgfail_6,bkgfail_7,bkgfail_8))
    sigpass = np.concatenate((sigpass_6_HMP,sigpass_7_HMP,sigpass_8_HMP))
    ...
    outputFilename = 'BBDT_SvB_wln_lep_HMP'
