...
OutDir = 'RBDT_SvB_220120_run2mc_4wln/'
createDir(OutDir)

branch_names = [
                   'VHH_H1_BJet1_btag','VHH_H1_BJet2_btag','VHH_H2_BJet1_btag','VHH_H2_BJet2_btag',
                    'selLeptons_pt_0', 'VHH_H1_pT','VHH_H2_pT',
                    'VHH_H1_m','VHH_H2_m','VHH_HH_m','VHH_HH_pT',
                    'selLeptons_phi_0','VHH_H1_phi','VHH_H2_phi'
                ]
branch_names_6 = copy.deepcopy(branch_names )
branch_names_6.append('2016')
branch_names_7 = copy.deepcopy(branch_names)
...
branch_nicknames = [
                'j1_btag','j2_btag','j3_btag','j4_btag','lep_pt','VHH_H1_pT','VHH_H2_pT','VHH_H1_m','VHH_H2_m',
                'VHH_HH_m','VHH_HH_pT','lep_phi','VHH_H1_phi','VHH_H2_phi',
                'dataYear'
                ]

passcut = ' (isWenu||isWmunu) && isResolved&&VHH_rHH>=0&&VHH_rHH<50&&VHH_nBJets>2 &&RBDT_c3_20vs0_0120>=0'
#passcut = ' (isZnn) && isResolved&&VHH_rHH>=0&&VHH_rHH<50&&VHH_nBJets>2 && RBDT_c3_20vs0>=0'
...
if train_svb_bdt:
    ...
    outputFilename = 'wlnRBDT_SvB_usekl20vs0_use_lpt_HighScore'
